...
public class ProcesadorMexico implements ProcesadorDocumento {

    @Override
    public String procesar(Documento documento) throws Exception {
        if (!"MX".equalsIgnoreCase(documento.getPais())) {
            throw new Exception("El procesador de Mexico solo acepta documentos de pais MX.");
        }
        ...
        return "Mexico - Procesando " + documento.getTipo()
